...
> **Status:** ✅ Feature-complete (v0.2.0). Engine, UI, calibration editor, data viewer, inline correction, auto-capture, and installers for Windows, macOS, and Linux (AppImage) are all in place. New users should start with [QUICKSTART.md](QUICKSTART.md).
